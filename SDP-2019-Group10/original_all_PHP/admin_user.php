...
<table width="100%" border="1" border-collapse: collapse;	>
  ...
  <tr>
    ...
    <td height="40"  valign="top"><input id="email" name="email" type="email" style="width:90% ;height:100%"/></td>
  </tr>
  <tr>
...
?>	<tr>
    ...
    <td width="10%">
    <button class='button' onclick="<?php echo("location.href='admin_edit_user.php?user_ID=$userID'");?> ">แก้ไข</button>
	</td>
    <td width="10%">
    <button class='button' onclick="<?php echo("location.href='admin_delete_user.php?user_ID=$userID'");?> ">ลบ</button>
  </td>
  </tr>
<?php } ?>
</table> 
